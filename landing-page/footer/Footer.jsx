...
const Footer = () => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-0 left-0 w-full h-8 flex text-xs text-white/30 tracking-widest overflow-hidden border-b border-white/10">
                {Array.from({ length: 30 }).map((_, i) => (
                    <div key={i} className="flex-1 border-r border-white/10 h-full flex items-end justify-center pb-1">
                        -0{i % 10}
                    </div>
                ))}
            </div>
